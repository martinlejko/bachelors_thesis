...
TEST_CASES = {
    ...
    "federal_reserve_policy": {
        ...
        "context": [
            "Investors anticipated potential rate cuts in 2024, leading to a rally in bonds and equities."
        ],
    },
    "geopolitical_tensions_markets": {
        ...
        "context": [
            "Investors became cautious due to uncertainty in global trade and energy markets."
        ],
    },
    ...
    "consumer_spending_2023": {
        ...
        "context": [
            "A resilient job market and wage growth supported household consumption."
        ],
    },
    "housing_market_interest_rates": {
        ...
        "context": [
            "Home sales slowed down due to higher borrowing costs and limited supply."
        ],
    },
    "bond_market_recovery": {
        ...
        "context": [
            "Investors anticipated a slowdown in rate hikes, leading to increased bond demand."
        ],
    },
    "stock_market_sectors_2023": {
        ...
        "context": [
            "AI advancements and strong consumer demand fueled sector performance."
        ],
    },
    "labor_market_resilience": {
        ...
        "context": [
            "Job openings stayed high, and wage growth continued despite economic uncertainties."
        ],
    },
    "energy_prices_impact": {
        ...
        "context": [
            "Supply constraints and geopolitical issues led to higher oil and gas prices."
        ],
    },
    "ai_investments_2023": {
        ...
        "context": [
            "Companies focused on AI adoption, boosting tech sector valuations."
        ],
    },
    "gold_performance_2023": {
        ...
        "context": [
            "Inflation fears and geopolitical tensions led to higher demand for safe-haven assets."
        ],
    },
    "cryptocurrency_rebound": {
        ...
        "context": [
            "Bitcoin and Ethereum saw gains as investor confidence improved."
        ],
    },
    "corporate_earnings_2023": {
        ...
        "context": [
            "Companies in key sectors reported better-than-expected profits, driving investor confidence."
        ],
    },
}
