...
\def\ThesisAuthor{\xxx{Martin Lejko}}
...
\def\Department{\xxx{Department of Software Engineering}}

% Is it a department (katedra), or an institute (ústav)?
\def\DeptType{\xxx{Department}}

% Thesis supervisor: name, surname and titles
\def\Supervisor{\xxx{Mgr. Petr Škoda, Ph.D.}}

% Supervisor's department (again according to Organizational structure of MFF)
\def\SupervisorsDepartment{\xxx{Department of Software Engineering}}
...
\def\ThesisKeywords{%
\xxx{fine-tuning\sep language model\sep natural language processing\sep artificial intelligence}
}
...
\def\DepartmentCS{\xxx{Katedra softwarového inženýrství}}
\def\DeptTypeCS{\xxx{Katedra}}
\def\SupervisorsDepartmentCS{\xxx{katedra vedoucího}}
\def\StudyProgrammeCS{\xxx{studijní program}}

\def\ThesisKeywordsCS{%
\xxx{doladění\sep jazykový model\sep zpracování přirozeného jazyka\sep umělá inteligence}
}
