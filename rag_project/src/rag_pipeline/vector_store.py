...
from src.common.config import EMBEDDING_MODEL, VECTOR_DB_PATH
...
class VectorStoreManager:
    ...
    def __init__(self, embedding_model: str = EMBEDDING_MODEL, persist_directory: Optional[Path] = None):
        """
