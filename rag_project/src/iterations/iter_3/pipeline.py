"""Iteration 3: Defines the pipeline logic for iteration 3."""

"""
Initial RAG pipeline implementation.

This module implements the third iteration of the RAG pipeline,
based on the proof of concept code. Implementing moderate cleaning of the data.
"""
...
from src.iterations.iter_3.processing.processor_iter_3 import DocumentProcessor
